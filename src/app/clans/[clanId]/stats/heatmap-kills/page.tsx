...
export default function ClanTelemetryHeatmapKillsPage() {
  ...
  }, [clanId, period, periodReady, mapName])
  ...
  return (
    ...
    <div className="app-main-flush flex-1">
      ...
      <DockingToolbar ariaLabel="Filtres de la heatmap des kills">
        {({ compact }) => (
          <div className="flex flex-wrap items-center gap-3">
            <PeriodFilter periods={STANDARD_PERIODS} value={period} onChange={setPeriod} />
            {!compact ? (
              <label className="flex min-w-[14rem] flex-1 items-center gap-2 text-sm text-gray-700 md:max-w-xs" htmlFor="telemetry-map-filter">
                Carte
                <select
      ...
      <div className="app-container app-gutter">
        {loading && !payload ? <p className="mb-4 text-sm text-gray-600">Chargement de la heatmap telemetry...</p> : null}
