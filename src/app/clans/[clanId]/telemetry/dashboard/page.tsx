...
import { Activity, AlertTriangle, FileText, Repeat, Users, ServerCrash } from 'lucide-react'
...
export default function TelemetryDashboard() {
  ...
  const isOwner = useMemo(() => {
    return isSuperUser || permissions.includes('*')
      ...
      {isOwner && (
        <section className="app-panel p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            ...
            <Link href={`/clans/${clanId}/telemetry/opponents`} className="flex flex-col items-center justify-center p-4 rounded-xl border border-gray-100 bg-gray-50 hover:bg-gray-100 transition-colors">
              <Users className="w-6 h-6 text-purple-500 mb-2" />
              <span className="text-sm font-semibold text-gray-900 text-center">Opponents</span>
            </Link>
          </div>
        </section>
      )}
